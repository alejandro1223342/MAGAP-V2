...
require_once "../modelos/Providencia.php";
...
switch ($_GET["op"]) {
    ...
    case 'tabla':
        ...
        $rspta = $providencia->tabla($s_ident);
        $data = array();
        if ($rspta) {
    ...
    case 'aprobardocumento':
        ...
        if ($primerRegistro !== false) {
            ...
            $rspta = $providencia->aprobardocumento($usu_id, $tra_id, $estado, $observacion);
    ...
    case 'guardardocumento':
        ...
        $rspta = $providencia->guardardocumento($tra_id, $cat_id_estado, $pro_observacion);
        break;
}
