                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control select2" style="width: 100%;" name="cat_tenencia" id="cat_tenencia">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-control select2" style="width: 100%;" name="cat_construccion" id="cat_construccion">
                                                                        <!-- Resto de opciones -->
                                                                    </select>
                                                                </div>
                                                            </div>
