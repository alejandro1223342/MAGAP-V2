                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <div class="fieldlabels">
                                ...
                                <select class="form-control select2" style="width: 100%;" name="cat_id_identificacion"
                                        id="cat_id_identificacion">
                    ...
                    <fieldset>
                        <div class="form-card">
                            ...
                            <div class="fieldlabels">
                                ...
                                <input type="password" class="form-control" name="sol_clave" id="sol_clave"
