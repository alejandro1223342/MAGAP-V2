...
function listar() {
    tabla = $("#tbllistado")
        .dataTable({
            ...
            ajax: {
                url: "../ajax/perfeccionamiento.php?op=listar",
                type: "get",
                dataType: "json",
                error: function (e) {
            ...
            callback: function (result) {
                if (result) {
                    if (result) {
                        ...
                        $.ajax({
                            url: "../ajax/perfeccionamiento.php?op=aprobardocumento",
                            type: "POST",
                            data: formData,
                            contentType: false,
                            processData: false,
...
function mostrarTabla(s_ident) {
    ...
    tabla_pdf = $('#tabla_pdf').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            url: '../ajax/perfeccionamiento.php?op=tabla&s_ident=' + s_ident,
            type: "GET",
            dataType: "json",
            error: function (e) {
                console.log(e.responseText);
    ...
    bootbox.confirm({
        ...
        callback: function (result) {
            ...
            if (result) {
                ...
                $.ajax({
                    url: "../ajax/perfeccionamiento.php?op=guardardocumento",
                    type: "POST",
                    data: datosFila,
